    ...
    public function getConversationLogs(Request $request)
    {
        ...
        try {
            ...
            if (isset($validatedData['user1'])) {
                ...
                return response()->json(apiResponse($logs, 'Data fetched successfully', 200)['error' => 'At least user1 parameter is required'], 422);
            }
            ...
            return response()->json(apiResponse($logs, 'Data fetched successfully', 200), 200);
        } catch (\Exception $e) {
