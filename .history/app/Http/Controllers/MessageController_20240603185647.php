    ...
    public function getConversationLogs(Request $request)
    {
        ...
        try {
            ...
            if (isset($validatedData['user1'])) {
                ...
                return response()->json(['message' => 'At least user1 parameter is required'], 422);
            }
            ...
            return response()->json(['status' => 500,, 'data' => $logs]);
        } catch (\Exception $e) {
            return response()->json(['status' => 500, 'data' => [], 'message' => 'Failed to retrieve conversation logs'], 500);
        }
    }
}
