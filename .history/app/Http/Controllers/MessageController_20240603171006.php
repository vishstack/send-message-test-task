        ...
        try {
            ...
            if (isset($validatedData['user1'])) {
                ...
                if (filter_var($user1Param, FILTER_VALIDATE_EMAIL)) {
                    $user1 = \App\Models\User::where('email', $user1Param)->first();
                } else {
                    $user1 = \App\Models\User::find($user1Param);
                }
                ...
                if (isset($validatedData['user2'])) {
                    ...
                    if (filter_var($user2Param, FILTER_VALIDATE_EMAIL)) {
                        $user2 = \App\Models\User::where('email', $user2Param)->first();
                    } else {
                        $user2 = \App\Models\User::find($user2Param);
                    }
