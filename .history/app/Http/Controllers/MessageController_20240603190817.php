...
class MessageController extends Controller
{
    ...
    public function getConversationLogs(Request $request)
    {
        ...
        try {
            ...
            return response()->json(apiResponse(null, 'Failed to retrieve conversation logs'), 200);
        } catch (\Exception $e) {
            return response()->json(apiResponse(null, 'Failed to retrieve conversation logs'), 500);
        }
    }
}
